# Generated by Django 2.2.12 on 2022-08-25 13:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('Female', 'Female'), ('Male', 'Male'), ('Rather not say', 'Rather not say')], max_length=15, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('receipt_type', models.CharField(choices=[('Revenue Receipt', 'Revenue Receipt'), ('Capital Receipt', 'Capital Receipt')], max_length=24, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('transaction_type', models.CharField(choices=[('Withdrawal', 'Withdrawal'), ('Deposit', 'Deposit')], max_length=10, null=True)),
                ('transaction_amount', models.PositiveIntegerField(null=True)),
                ('transaction_date_time', models.DateTimeField(blank=True, null=True)),
                ('status', models.CharField(choices=[('Complete', 'Complete'), ('Incomplete', 'Incomplete'), ('Pending', 'Pending')], max_length=18, null=True)),
                ('transaction_cost', models.PositiveIntegerField(null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('loan_term', models.CharField(choices=[('Short Term', 'Short Term'), ('Long Term', 'Long Term')], max_length=12, null=True)),
                ('loan_status', models.CharField(choices=[('Paid', 'Paid'), ('Unpaid', 'Unpaid')], max_length=15, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('card_type', models.CharField(choices=[('Debit', 'Debit'), ('Credit', 'Credit')], max_length=10, null=True)),
